  ...
  <div class="min-h-screen bg-[var(--color-background)]">
          ...
          <div class="grid grid-cols-12 gap-8">
            ...
            <div class="col-span-12 space-y-8 lg:col-span-8">
              ...
              <section v-if="nearbyPlaces.length > 0">
                <h3 class="mb-4 text-xl font-bold text-[var(--color-text)]">
                  함께 둘러보기 좋은 장소
                </h3>
    ...
    >
      ...
      >
        ...
        <h1 class="mt-6 text-2xl font-semibold text-[var(--color-text)]">
          {{
            error
              ? '장소 정보를 불러오지 못했습니다'
              : '장소를 찾을 수 없습니다'
...
import { getNearbyPlaces, getPlace } from '@/api/placeApi'
...
const loadPlace = async () => {
  ...
  try {
    ...
    try {
      ...
      nearbyPlaces.value = await getNearbyPlaces(
        placeId,
        3,
        reference,
      )
