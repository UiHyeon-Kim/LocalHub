      ...
      <div class="page-container">
        <div class="space-y-6">
          <header class="space-y-3">
            <p
              class="text-sm font-semibold uppercase tracking-[0.26em] text-[var(--color-secondary)]"
            >
              장소 둘러보기
            </p>
            ...
            <p
              class="max-w-2xl text-base leading-8 text-[var(--color-text-muted)]"
            >
              관광지, 문화시설, 음식점, 축제 등 다양한 지역 정보를 한눈에
              살펴보세요.
            </p>
          ...
          >
            ...
            >
              <div
                class="mb-4 h-44 rounded-[18px] bg-[var(--color-border)]"
              ></div>

              <div
                class="mb-3 h-5 w-3/4 rounded bg-[var(--color-border)]"
              ></div>

              <div
                class="mb-3 h-4 w-5/6 rounded bg-[var(--color-border)]"
              ></div>

              <div
                class="h-4 w-full rounded bg-[var(--color-border)]"
              ></div>
            </div>
          </div>
